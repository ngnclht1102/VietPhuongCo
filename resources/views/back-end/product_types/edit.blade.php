...
<!-- main content - noi dung chinh trong chu -->
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><small>Sửa thông tin kiểu sản phẩm</small></h1>
			</div>
		</div><!--/.row-->
						...
						<form action="" method="POST" role="form">
							  ...
							  <div class="form-group">
					      		...
					      		<select name="sltParent" id="inputSltCate" class="form-control">
					      			<option value="0" {!!($parent && $parent->id == 0) ? 'selected': '' !!}>- ROOT --</option>
									  @foreach($typeRoot as $row)
									  <option {!!($parent && $parent->id == $row->id) ? 'selected': '' !!} value="{!!$row->id!!}">---- {!!$row->name!!}</option>
									  @endforeach					      			
					      		</select>
				      		</div>    
