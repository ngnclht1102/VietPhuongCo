...
this.settings.preload&&this.contentContainer.css({visibility:"hidden",opacity:0});this.dom.carousel.prepend(a)},initNavigationButtons:function(){var a=this;if(this.settings.navigationButtonsVisible){var b=$('<a href="#" class="sc-nav-button sc-prev sc-no-select"></a>'),c=$('<a href="#" class="sc-nav-button sc-next sc-no-select"></a>');this.dom.carousel.append(b);this.dom.carousel.append(c);b.on("click",function(b){b.preventDefault();a.selectPrevious(a.settings.slideSpeed)});c.on("click",function(b){b.preventDefault();
